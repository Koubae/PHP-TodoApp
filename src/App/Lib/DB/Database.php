...
//        $query = file_get_contents(__DIR__ . "/$db_dump_file");
    ...
    datetime_create TIMESTAMP NOT NULL DEFAULT TIMESTAMP,
    datetime_write TIMESTAMP NOT NULL DEFAULT 
        ON UPDATE TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `task` (
    id MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    datetime_create TIMESTAMP NOT NULL DEFAULT TIMESTAMP,
    datetime_write TIMESTAMP NOT NULL DEFAULT TIMESTAMP ON UPDATE TIMESTAMP,
    name VARCHAR(50) NOT NULL,
